...
<table>
<tr><td>
    <span class="title"><?php echo xlt('open EMR Add Facility'); ?></span>&nbsp;&nbsp;&nbsp;</td>
...
<form name='facility-add' id='facility-add' method='post' action="facilities.php">
	...
	<tr>
	<td></td>
	<td>&nbsp;</td><td>&nbsp;</td><td><span class="text"><?php echo xlt('Mobile number'); ?>: </span></td><td><input type=entry name=mobile size=20 value=""></td>
	</tr>
        <tr>
