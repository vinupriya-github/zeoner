...
if ($formid) {
    $sql = "SELECT * FROM `custom_care_plan` WHERE id=? AND pid = ? AND encounter = ?";
...
<html>
    <head>
        <title><?php echo xlt("Customize Form"); ?></title>
        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                    <h2><?php echo xlt('Customize Form'); ?></h2>
                </div>
            </div>
            <div class="row">
            <?php echo "<form method='post' name='my_form' " . "action='$rootdir/forms/custom_new/save.php?id=" . attr_url($formid) . "'>\n"; ?>
